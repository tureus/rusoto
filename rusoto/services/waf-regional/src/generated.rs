...
pub trait WAFRegional {
    ...
    #[doc="<p>Permanently deletes a <a>RuleGroup</a>. You can't delete a <code>RuleGroup</code> if it's still used in any <code>WebACL</code> objects or if it still includes any rules.</p> <p>If you just want to remove a <code>RuleGroup</code> from a <code>WebACL</code>, use <a>UpdateWebACL</a>.</p> <p>To permanently delete a <code>RuleGroup</code> from AWS WAF, perform the following steps:</p> <ol> <li> <p>Update the <code>RuleGroup</code> to remove rules, if any. For more information, see <a>UpdateRuleGroup</a>.</p> </li> <li> <p>Use <a>GetChangeToken</a> to get the change token that you provide in the <code>ChangeToken</code> parameter of a <code>DeleteRuleGroup</code> request.</p> </li> <li> <p>Submit a <code>DeleteRuleGroup</code> request.</p> </li> </ol>"]
    ...
    #[doc = "<p>Returns the <a>GeoMatchSet</a> that is specified by <code>GeoMatchSetId</code>.</p>"]
    ...
    #[doc = "<p>Returns the <a>RegexMatchSet</a> specified by <code>RegexMatchSetId</code>.</p>"]
    fn get_regex_match_set(
        &self,
        input: &GetRegexMatchSetRequest,
    ) -> Result<GetRegexMatchSetResponse, GetRegexMatchSetError>;

    #[doc = "<p>Returns the <a>RegexPatternSet</a> specified by <code>RegexPatternSetId</code>.</p>"]
    ...
    #[doc="<p>Returns the <a>RuleGroup</a> that is specified by the <code>RuleGroupId</code> that you included in the <code>GetRuleGroup</code> request.</p> <p>To view the rules in a rule group, use <a>ListActivatedRulesInRuleGroup</a>.</p>"]
    fn get_rule_group(
        &self,
    ...
    #[doc = "<p>Returns an array of <a>ActivatedRule</a> objects.</p>"]
    ...
    #[doc = "<p>Returns an array of <a>GeoMatchSetSummary</a> objects in the response.</p>"]
    ...
    #[doc = "<p>Returns an array of <a>RegexMatchSetSummary</a> objects.</p>"]
    fn list_regex_match_sets(
        &self,
        input: &ListRegexMatchSetsRequest,
    ) -> Result<ListRegexMatchSetsResponse, ListRegexMatchSetsError>;

    #[doc = "<p>Returns an array of <a>RegexPatternSetSummary</a> objects.</p>"]
    ...
    #[doc = "<p>Returns an array of <a>RuleGroup</a> objects.</p>"]
    fn list_rule_groups(
        &self,
    ...
    #[doc = "<p>Returns an array of <a>RuleGroup</a> objects that you are subscribed to.</p>"]
