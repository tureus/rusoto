...
pub trait DynamoDb {
    ...
    #[doc="<p>Deletes an existing backup of a table.</p> <p>You can call <code>DeleteBackup</code> at a maximum rate of 10 times per second.</p>"]
    fn delete_backup(
        &self,
    ...
    #[doc="<p>Describes an existing backup of a table.</p> <p>You can call <code>DescribeBackup</code> at a maximum rate of 10 times per second.</p>"]
    fn describe_backup(
        &self,
        input: &DescribeBackupInput,
    ) -> Result<DescribeBackupOutput, DescribeBackupError>;

    #[doc="<p>Checks the status of the backup restore settings on the specified table. If backups are enabled, <code>ContinuousBackupsStatus</code> will bet set to ENABLED.</p> <p>You can call <code>DescribeContinuousBackups</code> at a maximum rate of 10 times per second.</p>"]
    fn describe_continuous_backups(
        &self,
        input: &DescribeContinuousBackupsInput,
    ) -> Result<DescribeContinuousBackupsOutput, DescribeContinuousBackupsError>;

    #[doc = "<p>Returns information about the global table.</p>"]
    ...
    #[doc="<p>Adds or removes replicas to the specified global table. The global table should already exist to be able to use this operation. Currently, the replica to be added should be empty. </p>"]
