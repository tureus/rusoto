...
pub trait Glacier {
    ...
    fn create_vault(&self, input: &CreateVaultInput)
    ...
    #[doc="<p>This operation initiates a job of the specified type, which can be a select, an archival retrieval, or a vault retrieval. For more information about using this operation, see the documentation for the underlying REST API <a href=\"http://docs.aws.amazon.com/amazonglacier/latest/dev/api-initiate-job-post.html\">Initiate a Job</a>. </p>"]
    ...
    #[doc="<p>This operation lists the provisioned capacity units for the specified AWS account.</p>"]
