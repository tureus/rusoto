...
pub struct ConstraintDetail {
    ...
    /// <p>The type of constraint.</p> <ul> <li> <p> <code>LAUNCH</code> </p> </li> <li> <p> <code>NOTIFICATION</code> </p> </li> <li> <p> <code>TEMPLATE</code> </p> </li> </ul>
    #[serde(rename = "Type")]
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct RecordDetail {
    ...
    /// <p>The record type for this record.</p> <ul> <li> <p> <code>PROVISION_PRODUCT</code> </p> </li> <li> <p> <code>UPDATE_PROVISIONED_PRODUCT</code> </p> </li> <li> <p> <code>TERMINATE_PROVISIONED_PRODUCT</code> </p> </li> </ul>
...
pub trait ServiceCatalog {
    #[doc = "<p>Accepts an offer to share the specified portfolio.</p>"]
    ...
    #[doc = "<p>Associates the specified product with the specified portfolio.</p>"]
    fn associate_product_with_portfolio(
        &self,
        input: &AssociateProductWithPortfolioInput,
    ) -> Result<AssociateProductWithPortfolioOutput, AssociateProductWithPortfolioError>;

    #[doc = "<p>Associate the specified TagOption with the specified portfolio or product.</p>"]
    ...
    #[doc="<p>Deletes the specified portfolio.</p> <p>You cannot delete a portfolio if it was shared with you or if it has associated products, users, constraints, or shared accounts.</p>"]
    fn delete_portfolio(
        &self,
        input: &DeletePortfolioInput,
    ) -> Result<DeletePortfolioOutput, DeletePortfolioError>;

    #[doc = "<p>Stops sharing the specified portfolio with the specified account.</p>"]
    fn delete_portfolio_share(
        &self,
        input: &DeletePortfolioShareInput,
    ) -> Result<DeletePortfolioShareOutput, DeletePortfolioShareError>;

    #[doc="<p>Deletes the specified product.</p> <p>You cannot delete a product if it was shared with you or is associated with a portfolio.</p>"]
    fn delete_product(
        &self,
        input: &DeleteProductInput,
    ) -> Result<DeleteProductOutput, DeleteProductError>;

    #[doc="<p>Deletes the specified provisioning artifact (also known as a version) for the specified product.</p> <p>You cannot delete a provisioning artifact associated with a product that was shared with you. You cannot delete the last provisioning artifact for a product, because a product must have at least one provisioning artifact.</p>"]
    fn delete_provisioning_artifact(
        &self,
        input: &DeleteProvisioningArtifactInput,
    ) -> Result<DeleteProvisioningArtifactOutput, DeleteProvisioningArtifactError>;

    #[doc = "<p>Gets information about the specified constraint.</p>"]
    fn describe_constraint(
        &self,
        input: &DescribeConstraintInput,
    ) -> Result<DescribeConstraintOutput, DescribeConstraintError>;

    #[doc = "<p>Gets the status of the specified copy product operation.</p>"]
    fn describe_copy_product_status(
        &self,
        input: &DescribeCopyProductStatusInput,
    ) -> Result<DescribeCopyProductStatusOutput, DescribeCopyProductStatusError>;

    #[doc = "<p>Gets information about the specified portfolio.</p>"]
    fn describe_portfolio(
        &self,
        input: &DescribePortfolioInput,
    ) -> Result<DescribePortfolioOutput, DescribePortfolioError>;

    #[doc = "<p>Gets information about the specified product.</p>"]
    fn describe_product(
        &self,
        input: &DescribeProductInput,
    ) -> Result<DescribeProductOutput, DescribeProductError>;

    #[doc="<p>Gets information about the specified product. This operation is run with administrator access.</p>"]
    ...
    #[doc = "<p>Gets information about the specified provisioned product.</p>"]
    fn describe_provisioned_product(
        &self,
        input: &DescribeProvisionedProductInput,
    ) -> Result<DescribeProvisionedProductOutput, DescribeProvisionedProductError>;

    #[doc="<p>Gets information about the specified provisioning artifact (also known as a version) for the specified product.</p>"]
    fn describe_provisioning_artifact(
        &self,
        input: &DescribeProvisioningArtifactInput,
    ) -> Result<DescribeProvisioningArtifactOutput, DescribeProvisioningArtifactError>;

    #[doc="<p>Gets information about the configuration required to provision the specified product using the specified provisioning artifact.</p> <p>If the output contains a TagOption key with an empty list of values, there is a TagOption conflict for that key. The end user cannot take action to fix the conflict, and launch is not blocked. In subsequent calls to <a>ProvisionProduct</a>, do not include conflicted TagOption keys as tags, or this will cause the error \"Parameter validation failed: Missing required parameter in Tags[<i>N</i>]:<i>Value</i>\" and tag the provisioned product with the value <code>sc-tagoption-conflict-portfolioId-productId</code>.</p>"]
    ...
    #[doc="<p>Gets information about the specified request operation.</p> <p>Use this operation after calling a request operation (for example, <a>ProvisionProduct</a>, <a>TerminateProvisionedProduct</a>, or <a>UpdateProvisionedProduct</a>). </p>"]
    fn describe_record(
        &self,
        input: &DescribeRecordInput,
    ) -> Result<DescribeRecordOutput, DescribeRecordError>;

    #[doc = "<p>Gets information about the specified TagOption.</p>"]
    ...
    #[doc = "<p>Disassociates the specified TagOption from the specified resource.</p>"]
    ...
    #[doc = "<p>Lists all portfolios for which sharing was accepted by this account.</p>"]
    fn list_accepted_portfolio_shares(
        &self,
        input: &ListAcceptedPortfolioSharesInput,
    ) -> Result<ListAcceptedPortfolioSharesOutput, ListAcceptedPortfolioSharesError>;

    #[doc = "<p>Lists the constraints for the specified portfolio and product.</p>"]
    fn list_constraints_for_portfolio(
        &self,
        input: &ListConstraintsForPortfolioInput,
    ) -> Result<ListConstraintsForPortfolioOutput, ListConstraintsForPortfolioError>;

    #[doc="<p>Lists the paths to the specified product. A path is how the user has access to a specified product, and is necessary when provisioning a product. A path also determines the constraints put on the product.</p>"]
    fn list_launch_paths(
        &self,
        input: &ListLaunchPathsInput,
    ) -> Result<ListLaunchPathsOutput, ListLaunchPathsError>;

    #[doc = "<p>Lists the account IDs that have access to the specified portfolio.</p>"]
    ...
    #[doc="<p>Lists all provisioning artifacts (also known as versions) for the specified product.</p>"]
    fn list_provisioning_artifacts(
        &self,
        input: &ListProvisioningArtifactsInput,
    ) -> Result<ListProvisioningArtifactsOutput, ListProvisioningArtifactsError>;

    #[doc = "<p>Lists the specified requests or all performed requests.</p>"]
    fn list_record_history(
        &self,
        input: &ListRecordHistoryInput,
    ) -> Result<ListRecordHistoryOutput, ListRecordHistoryError>;

    #[doc = "<p>Lists the resources associated with the specified TagOption.</p>"]
    fn list_resources_for_tag_option(
        &self,
        input: &ListResourcesForTagOptionInput,
    ) -> Result<ListResourcesForTagOptionOutput, ListResourcesForTagOptionError>;

    #[doc = "<p>Lists the specified TagOptions or all TagOptions.</p>"]
    fn list_tag_options(
        &self,
        input: &ListTagOptionsInput,
    ) -> Result<ListTagOptionsOutput, ListTagOptionsError>;

    #[doc="<p>Provisions the specified product.</p> <p>A provisioned product is a resourced instance of a product. For example, provisioning a product based on a CloudFormation template launches a CloudFormation stack and its underlying resources. You can check the status of this request using <a>DescribeRecord</a>.</p> <p>If the request contains a tag key with an empty list of values, there is a tag conflict for that key. Do not include conflicted keys as tags, or this will cause the error \"Parameter validation failed: Missing required parameter in Tags[<i>N</i>]:<i>Value</i>\".</p>"]
    fn provision_product(
        &self,
        input: &ProvisionProductInput,
    ) -> Result<ProvisionProductOutput, ProvisionProductError>;

    #[doc = "<p>Rejects an offer to share the specified portfolio.</p>"]
    fn reject_portfolio_share(
        &self,
        input: &RejectPortfolioShareInput,
    ) -> Result<RejectPortfolioShareOutput, RejectPortfolioShareError>;

    #[doc = "<p>Lists the provisioned products that are available (not terminated).</p>"]
    fn scan_provisioned_products(
        &self,
        input: &ScanProvisionedProductsInput,
    ) -> Result<ScanProvisionedProductsOutput, ScanProvisionedProductsError>;

    #[doc = "<p>Gets information about the products to which the caller has access.</p>"]
    fn search_products(
        &self,
        input: &SearchProductsInput,
    ) -> Result<SearchProductsOutput, SearchProductsError>;

    #[doc="<p>Gets information about the products for the specified portfolio or all products.</p>"]
    fn search_products_as_admin(
        &self,
        input: &SearchProductsAsAdminInput,
    ) -> Result<SearchProductsAsAdminOutput, SearchProductsAsAdminError>;

    #[doc="<p>Terminates the specified provisioned product.</p> <p>This operation does not delete any records associated with the provisioned product.</p> <p>You can check the status of this request using <a>DescribeRecord</a>.</p>"]
    fn terminate_provisioned_product(
        &self,
        input: &TerminateProvisionedProductInput,
    ) -> Result<TerminateProvisionedProductOutput, TerminateProvisionedProductError>;

    #[doc = "<p>Updates the specified constraint.</p>"]
    fn update_constraint(
        &self,
        input: &UpdateConstraintInput,
    ) -> Result<UpdateConstraintOutput, UpdateConstraintError>;

    #[doc="<p>Updates the specified portfolio.</p> <p>You cannot update a product that was shared with you.</p>"]
    fn update_portfolio(
        &self,
        input: &UpdatePortfolioInput,
    ) -> Result<UpdatePortfolioOutput, UpdatePortfolioError>;

    #[doc = "<p>Updates the specified product.</p>"]
    fn update_product(
        &self,
        input: &UpdateProductInput,
    ) -> Result<UpdateProductOutput, UpdateProductError>;

    #[doc="<p>Requests updates to the configuration of the specified provisioned product.</p> <p>If there are tags associated with the object, they cannot be updated or added. Depending on the specific updates requested, this operation can update with no interruption, with some interruption, or replace the provisioned product entirely.</p> <p>You can check the status of this request using <a>DescribeRecord</a>.</p>"]
    fn update_provisioned_product(
        &self,
        input: &UpdateProvisionedProductInput,
    ) -> Result<UpdateProvisionedProductOutput, UpdateProvisionedProductError>;

    #[doc="<p>Updates the specified provisioning artifact (also known as a version) for the specified product.</p> <p>You cannot update a provisioning artifact for a product that was shared with you.</p>"]
    fn update_provisioning_artifact(
        &self,
        input: &UpdateProvisioningArtifactInput,
    ) -> Result<UpdateProvisioningArtifactOutput, UpdateProvisioningArtifactError>;

    #[doc = "<p>Updates the specified TagOption.</p>"]
