...
pub trait CloudDirectory {
    ...
    #[doc="<p>Copies the input published schema, at the specified version, into the <a>Directory</a> with the same name and version as that of the published schema.</p>"]
    fn apply_schema(
        &self,
    ...
    #[doc="<p>Performs all the write operations in a batch. Either all the operations succeed or none.</p>"]
    ...
    #[doc = "<p>Returns current applied schema version ARN, including the minor version in use.</p>"]
    ...
    #[doc="<p>Lists schema major versions applied to a directory. If <code>SchemaArn</code> is provided, lists the minor version.</p>"]
    ...
    #[doc = "<p>Lists indices attached to the specified object.</p>"]
    ...
    #[doc = "<p>Lists objects and indexed values attached to the index.</p>"]
    ...
    #[doc="<p>Lists schema major versions for a published schema. If <code>SchemaArn</code> is provided, lists the minor version.</p>"]
    ...
    #[doc="<p>Publishes a development schema with a major version and a recommended minor version.</p>"]
    fn publish_schema(
        &self,
    ...
    #[doc="<p>Upgrades a single directory in-place using the <code>PublishedSchemaArn</code> with schema updates found in <code>MinorVersion</code>. Backwards-compatible minor version upgrades are instantaneously available for readers on all objects in the directory. Note: This is a synchronous API call and upgrades only one schema on a given directory per call. To upgrade multiple directories from one schema, you would need to call this API on each directory.</p>"]
    fn upgrade_applied_schema(
        &self,
        input: &UpgradeAppliedSchemaRequest,
    ) -> Result<UpgradeAppliedSchemaResponse, UpgradeAppliedSchemaError>;

    #[doc="<p>Upgrades a published schema under a new minor version revision using the current contents of <code>DevelopmentSchemaArn</code>.</p>"]
