...
pub trait Glue {
    ...
    #[doc = "<p>Stops a batch of job runs for a given job.</p>"]
    fn batch_stop_job_run(
        &self,
        input: &BatchStopJobRunRequest,
    ) -> Result<BatchStopJobRunResponse, GlueBatchStopJobRunError>;

    #[doc="<p>Creates a classifier in the user's account. This may be either a <code>GrokClassifier</code> or an <code>XMLClassifier</code>. </p>"]
    ...
    #[doc="<p>Creates a new crawler with specified targets, role, configuration, and optional schedule. At least one crawl target must be specified, in either the <i>s3Targets</i> or the <i>jdbcTargets</i> field.</p>"]
    fn create_crawler(
        &self,
    ...
    #[doc = "<p>Removes a classifier from the Data Catalog.</p>"]
    ...
    #[doc="<p>Removes a specified crawler from the Data Catalog, unless the crawler state is <code>RUNNING</code>.</p>"]
    fn delete_crawler(
        &self,
    ...
    #[doc = "<p>Retrieve a classifier by name.</p>"]
    fn get_classifier(
        &self,
        input: &GetClassifierRequest,
    ) -> Result<GetClassifierResponse, GetClassifierError>;

    #[doc = "<p>Lists all classifier objects in the Data Catalog.</p>"]
    fn get_classifiers(
        &self,
    ...
    #[doc = "<p>Retrieves metadata for a specified crawler.</p>"]
    ...
    #[doc = "<p>Retrieves metadata for all crawlers defined in the customer account.</p>"]
    fn get_crawlers(
        &self,
    ...
    #[doc="<p>Starts a crawl using the specified crawler, regardless of what is scheduled. If the crawler is already running, does nothing.</p>"]
    fn start_crawler(
        &self,
    ...
    #[doc = "<p>If the specified crawler is running, stops the crawl.</p>"]
    fn stop_crawler(
        &self,
    ...
    #[doc="<p>Modifies an existing classifier (either a <code>GrokClassifier</code> or an <code>XMLClassifier</code>).</p>"]
    ...
    #[doc="<p>Updates a crawler. If a crawler is running, you must stop it using <code>StopCrawler</code> before updating it.</p>"]
    fn update_crawler(
        &self,
        input: &UpdateCrawlerRequest,
    ) -> Result<UpdateCrawlerResponse, UpdateCrawlerError>;

    #[doc = "<p>Updates the schedule of a crawler using a <code>cron</code> expression. </p>"]
