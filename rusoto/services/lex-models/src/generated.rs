...
pub trait LexModels {
    ...
    #[doc="<p>Returns metadata information for a specific bot. You must provide the bot name and the bot version or alias. </p> <p> This operation requires permissions for the <code>lex:GetBot</code> action. </p>"]
    ...
    #[doc = "<p>Exports the contents of a Amazon Lex resource in a specified format. </p>"]
