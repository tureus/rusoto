...
pub trait Workspaces {
    #[doc = "<p>Creates tags for the specified WorkSpace.</p>"]
    fn create_tags(&self, input: &CreateTagsRequest) -> Result<CreateTagsResult, CreateTagsError>;

    #[doc="<p>Creates one or more WorkSpaces.</p> <p>This operation is asynchronous and returns before the WorkSpaces are created.</p>"]
    fn create_workspaces(
        &self,
        input: &CreateWorkspacesRequest,
    ) -> Result<CreateWorkspacesResult, CreateWorkspacesError>;

    #[doc = "<p>Deletes the specified tags from a WorkSpace.</p>"]
    fn delete_tags(&self, input: &DeleteTagsRequest) -> Result<DeleteTagsResult, DeleteTagsError>;

    #[doc = "<p>Describes the tags for the specified WorkSpace.</p>"]
    fn describe_tags(
        &self,
        input: &DescribeTagsRequest,
    ) -> Result<DescribeTagsResult, DescribeTagsError>;

    #[doc="<p>Describes the available WorkSpace bundles.</p> <p>You can filter the results using either bundle ID or owner, but not both.</p>"]
    ...
    #[doc="<p>Describes the available AWS Directory Service directories that are registered with Amazon WorkSpaces.</p>"]
    fn describe_workspace_directories(
        &self,
        input: &DescribeWorkspaceDirectoriesRequest,
    ) -> Result<DescribeWorkspaceDirectoriesResult, DescribeWorkspaceDirectoriesError>;

    #[doc="<p>Describes the specified WorkSpaces.</p> <p>You can filter the results using bundle ID, directory ID, or owner, but you can specify only one filter at a time.</p>"]
    fn describe_workspaces(
        &self,
        input: &DescribeWorkspacesRequest,
    ) -> Result<DescribeWorkspacesResult, DescribeWorkspacesError>;

    #[doc = "<p>Describes the connection status of the specified WorkSpaces.</p>"]
    ...
    #[doc = "<p>Modifies the specified WorkSpace properties.</p>"]
    ...
    #[doc="<p>Reboots the specified WorkSpaces.</p> <p>You cannot reboot a WorkSpace unless its state is <code>AVAILABLE</code>, <code>IMPAIRED</code>, or <code>INOPERABLE</code>.</p> <p>This operation is asynchronous and returns before the WorkSpaces have rebooted.</p>"]
    fn reboot_workspaces(
        &self,
        input: &RebootWorkspacesRequest,
    ) -> Result<RebootWorkspacesResult, RebootWorkspacesError>;

    #[doc="<p>Rebuilds the specified WorkSpaces.</p> <p>You cannot rebuild a WorkSpace unless its state is <code>AVAILABLE</code> or <code>ERROR</code>.</p> <p>Rebuilding a WorkSpace is a potentially destructive action that can result in the loss of data. For more information, see <a href=\"http://docs.aws.amazon.com/workspaces/latest/adminguide/reset-workspace.html\">Rebuild a WorkSpace</a>.</p> <p>This operation is asynchronous and returns before the WorkSpaces have been completely rebuilt.</p>"]
    fn rebuild_workspaces(
        &self,
        input: &RebuildWorkspacesRequest,
    ) -> Result<RebuildWorkspacesResult, RebuildWorkspacesError>;

    #[doc="<p>Starts the specified WorkSpaces.</p> <p>You cannot start a WorkSpace unless it has a running mode of <code>AutoStop</code> and a state of <code>STOPPED</code>.</p>"]
    fn start_workspaces(
        &self,
        input: &StartWorkspacesRequest,
    ) -> Result<StartWorkspacesResult, StartWorkspacesError>;

    #[doc="<p> Stops the specified WorkSpaces.</p> <p>You cannot stop a WorkSpace unless it has a running mode of <code>AutoStop</code> and a state of <code>AVAILABLE</code>, <code>IMPAIRED</code>, <code>UNHEALTHY</code>, or <code>ERROR</code>.</p>"]
    fn stop_workspaces(
        &self,
        input: &StopWorkspacesRequest,
    ) -> Result<StopWorkspacesResult, StopWorkspacesError>;

    #[doc="<p>Terminates the specified WorkSpaces.</p> <p>Terminating a WorkSpace is a permanent action and cannot be undone. The user's data is destroyed. If you need to archive any user data, contact Amazon Web Services before terminating the WorkSpace.</p> <p>You can terminate a WorkSpace that is in any state except <code>SUSPENDED</code>.</p> <p>This operation is asynchronous and returns before the WorkSpaces have been completely terminated.</p>"]
