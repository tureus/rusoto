...
pub trait ApiGateway {
    ...
    #[doc="<p>Creates a VPC link, under the caller's account in a selected region, in an asynchronous operation that typically takes 2-4 minutes to complete and become operational. The caller must have permissions to create and update VPC Endpoint services.</p>"]
    ...
    fn delete_usage_plan(&self, input: &DeleteUsagePlanRequest)
    ...
    #[doc = "<p>Deletes an existing <a>VpcLink</a> of a specified identifier.</p>"]
    ...
    fn flush_stage_cache(&self, input: &FlushStageCacheRequest)
    ...
    #[doc="<p>Gets the <a>GatewayResponses</a> collection on the given <a>RestApi</a>. If an API developer has not added any definitions for gateway responses, the result will be the API Gateway-generated default <a>GatewayResponses</a> collection for the supported response types.</p>"]
    fn get_gateway_responses(
        &self,
        input: &GetGatewayResponsesRequest,
    ) -> Result<GatewayResponses, GetGatewayResponsesError>;

    #[doc = "<p>Get the integration settings.</p>"]
    fn get_integration(
        &self,
    ...
    #[doc = "<p>Gets the Tags collection for a given resource.</p>"]
    ...
    #[doc = "<p>Gets a specified VPC link under the caller's account in a region.</p>"]
    fn get_vpc_link(&self, input: &GetVpcLinkRequest) -> Result<VpcLink, GetVpcLinkError>;

    #[doc="<p>Gets the <a>VpcLinks</a> collection under the caller's account in a selected region.</p>"]
    ...
    #[doc="<p>A feature of the API Gateway control service for creating a new API from an external API definition file.</p>"]
    ...
    #[doc="<p>A feature of the API Gateway control service for updating an existing API with an input of external API definitions. The update can take the form of merging the supplied definition into the existing API or overwriting the existing API.</p>"]
    fn put_rest_api(&self, input: &PutRestApiRequest) -> Result<RestApi, PutRestApiError>;

    #[doc = "<p>Adds or updates Tags on a gievn resource.</p>"]
    ...
    #[doc = "<p>Removes Tags from a given resource.</p>"]
    ...
    #[doc = "<p>Updates an existing <a>VpcLink</a> of a specified identifier.</p>"]
