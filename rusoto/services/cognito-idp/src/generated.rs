...
pub trait CognitoIdentityProvider {
    ...
    #[doc="<p>Lists a history of user activity and any risks detected as part of Amazon Cognito advanced security.</p>"]
    ...
    #[doc = "<p>Sets the user's multi-factor authentication (MFA) preference.</p>"]
    ...
    #[doc="<p>Provides feedback for an authentication event as to whether it was from a valid user. This feedback is used for improving the risk evaluation decision for the user pool as part of Amazon Cognito advanced security.</p>"]
    ...
    #[doc="<p>Returns a unique generated shared secret key code for the user account. The request takes an access token or a session string, but not both.</p>"]
    ...
    #[doc = "<p>Describes the risk configuration.</p>"]
    ...
    #[doc = "<p>Gets the user pool multi-factor authentication (MFA) configuration.</p>"]
    ...
    #[doc="<p>Provides the feedback for an authentication event whether it was from a valid user or not. This feedback is used for improving the risk evaluation decision for the user pool as part of Amazon Cognito advanced security.</p>"]
    ...
    #[doc="<p>Use this API to register a user's entered TOTP code and mark the user's software token MFA status as \"verified\" if successful,</p>"]
