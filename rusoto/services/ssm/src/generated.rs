...
pub trait Ssm {
    ...
    #[doc="<p>Creates a patch baseline.</p> <note> <p>For information about valid key and value pairs in <code>PatchFilters</code> for each supported operating system type, see <a href=\"http://docs.aws.amazon.com/systems-manager/latest/APIReference/API_PatchFilter.html\">PatchFilter</a>.</p> </note>"]
    ...
    #[doc="<p>Information about all active and terminated step executions in an Automation workflow.</p>"]
    ...
    #[doc = "<p>Describes the specified Systems Manager document.</p>"]
    ...
    #[doc = "<p>Gets the contents of the specified Systems Manager document.</p>"]
    fn get_document(
        &self,
    ...
    #[doc = "<p>Describes one or more of your Systems Manager documents.</p>"]
    fn list_documents(
        &self,
