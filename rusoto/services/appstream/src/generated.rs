...
pub trait AppStream {
    #[doc = "<p>Associates the specified fleet with the specified stack.</p>"]
    fn associate_fleet(
        &self,
        input: &AssociateFleetRequest,
    ) -> Result<AssociateFleetResult, AssociateFleetError>;

    #[doc = "<p>Creates a directory configuration.</p>"]
    ...
    #[doc = "<p>Creates a fleet.</p>"]
    fn create_fleet(
        &self,
        input: &CreateFleetRequest,
    ) -> Result<CreateFleetResult, CreateFleetError>;

    #[doc="<p>Creates an image builder.</p> <p>The initial state of the builder is <code>PENDING</code>. When it is ready, the state is <code>RUNNING</code>.</p>"]
    fn create_image_builder(
        &self,
        input: &CreateImageBuilderRequest,
    ) -> Result<CreateImageBuilderResult, CreateImageBuilderError>;

    #[doc = "<p>Creates a URL to start an image builder streaming session.</p>"]
    ...
    #[doc = "<p>Deletes the specified fleet.</p>"]
    fn delete_fleet(
        &self,
        input: &DeleteFleetRequest,
    ) -> Result<DeleteFleetResult, DeleteFleetError>;

    #[doc="<p>Deletes the specified image. You cannot delete an image that is currently in use. After you delete an image, you cannot provision new capacity using the image.</p>"]
    fn delete_image(
        &self,
        input: &DeleteImageRequest,
    ) -> Result<DeleteImageResult, DeleteImageError>;

    #[doc = "<p>Deletes the specified image builder and releases the capacity.</p>"]
    fn delete_image_builder(
        &self,
        input: &DeleteImageBuilderRequest,
    ) -> Result<DeleteImageBuilderResult, DeleteImageBuilderError>;

    #[doc="<p>Deletes the specified stack. After this operation completes, the environment can no longer be activated and any reservations made for the stack are released.</p>"]
    fn delete_stack(
        &self,
        input: &DeleteStackRequest,
    ) -> Result<DeleteStackResult, DeleteStackError>;

    #[doc = "<p>Describes the specified directory configurations.</p>"]
    ...
    #[doc = "<p>Describes the specified fleets or all fleets in the account.</p>"]
    fn describe_fleets(
        &self,
        input: &DescribeFleetsRequest,
    ) -> Result<DescribeFleetsResult, DescribeFleetsError>;

    #[doc = "<p>Describes the specified image builders or all image builders in the account.</p>"]
    ...
    #[doc = "<p>Describes the specified images or all images in the account.</p>"]
    fn describe_images(
        &self,
        input: &DescribeImagesRequest,
    ) -> Result<DescribeImagesResult, DescribeImagesError>;

    #[doc="<p>Describes the streaming sessions for the specified stack and fleet. If a user ID is provided, only the streaming sessions for only that user are returned. If an authentication type is not provided, the default is to authenticate users using a streaming URL.</p>"]
    fn describe_sessions(
        &self,
        input: &DescribeSessionsRequest,
    ) -> Result<DescribeSessionsResult, DescribeSessionsError>;

    #[doc = "<p>Describes the specified stacks or all stacks in the account.</p>"]
    fn describe_stacks(
        &self,
        input: &DescribeStacksRequest,
    ) -> Result<DescribeStacksResult, DescribeStacksError>;

    #[doc = "<p>Disassociates the specified fleet from the specified stack.</p>"]
    fn disassociate_fleet(
        &self,
        input: &DisassociateFleetRequest,
    ) -> Result<DisassociateFleetResult, DisassociateFleetError>;

    #[doc = "<p>Stops the specified streaming session.</p>"]
    fn expire_session(
        &self,
        input: &ExpireSessionRequest,
    ) -> Result<ExpireSessionResult, ExpireSessionError>;

    #[doc = "<p>Lists the fleets associated with the specified stack.</p>"]
    fn list_associated_fleets(
        &self,
        input: &ListAssociatedFleetsRequest,
    ) -> Result<ListAssociatedFleetsResult, ListAssociatedFleetsError>;

    #[doc = "<p>Lists the stacks associated with the specified fleet.</p>"]
    fn list_associated_stacks(
        &self,
        input: &ListAssociatedStacksRequest,
    ) -> Result<ListAssociatedStacksResult, ListAssociatedStacksError>;

    #[doc="<p>Lists the tags for the specified AppStream 2.0 resource. You can tag AppStream 2.0 image builders, images, fleets, and stacks.</p> <p>For more information about tags, see <a href=\"http://docs.aws.amazon.com/appstream2/latest/developerguide/tagging-basic\">Tagging Your Resources</a> in the <i>Amazon AppStream 2.0 Developer Guide</i>.</p>"]
    fn list_tags_for_resource(
        &self,
        input: &ListTagsForResourceRequest,
    ) -> Result<ListTagsForResourceResponse, ListTagsForResourceError>;

    #[doc = "<p>Starts the specified fleet.</p>"]
    fn start_fleet(&self, input: &StartFleetRequest) -> Result<StartFleetResult, StartFleetError>;

    #[doc = "<p>Starts the specified image builder.</p>"]
    fn start_image_builder(
        &self,
        input: &StartImageBuilderRequest,
    ) -> Result<StartImageBuilderResult, StartImageBuilderError>;

    #[doc = "<p>Stops the specified fleet.</p>"]
    fn stop_fleet(&self, input: &StopFleetRequest) -> Result<StopFleetResult, StopFleetError>;

    #[doc = "<p>Stops the specified image builder.</p>"]
    fn stop_image_builder(
        &self,
        input: &StopImageBuilderRequest,
    ) -> Result<StopImageBuilderResult, StopImageBuilderError>;

    #[doc="<p>Adds or overwrites one or more tags for the specified AppStream 2.0 resource. You can tag AppStream 2.0 image builders, images, fleets, and stacks.</p> <p>Each tag consists of a key and an optional value. If a resource already has a tag with the same key, this operation updates its value.</p> <p>To list the current tags for your resources, use <a>ListTagsForResource</a>. To disassociate tags from your resources, use <a>UntagResource</a>.</p> <p>For more information about tags, see <a href=\"http://docs.aws.amazon.com/appstream2/latest/developerguide/tagging-basic\">Tagging Your Resources</a> in the <i>Amazon AppStream 2.0 Developer Guide</i>.</p>"]
    fn tag_resource(
        &self,
        input: &TagResourceRequest,
    ) -> Result<TagResourceResponse, TagResourceError>;

    #[doc="<p>Disassociates the specified tags from the specified AppStream 2.0 resource.</p> <p>To list the current tags for your resources, use <a>ListTagsForResource</a>.</p> <p>For more information about tags, see <a href=\"http://docs.aws.amazon.com/appstream2/latest/developerguide/tagging-basic\">Tagging Your Resources</a> in the <i>Amazon AppStream 2.0 Developer Guide</i>.</p>"]
    fn untag_resource(
        &self,
        input: &UntagResourceRequest,
    ) -> Result<UntagResourceResponse, UntagResourceError>;

    #[doc = "<p>Updates the specified directory configuration.</p>"]
