...
pub trait Lightsail {
    ...
    #[doc="<p>Attaches a block storage disk to a running or stopped Lightsail instance and exposes it to the instance with the specified disk name.</p>"]
    fn attach_disk(&self, input: &AttachDiskRequest) -> Result<AttachDiskResult, AttachDiskError>;

    #[doc = "<p>Attaches one or more Lightsail instances to a load balancer.</p>"]
    ...
    #[doc="<p>Attaches a Transport Layer Security (TLS) certificate to your load balancer.</p> <p>TLS is just an updated, more secure version of Secure Socket Layer (SSL).</p>"]
    ...
    #[doc="<p>Creates a Lightsail load balancer.</p> <p>When you create a load balancer, you can specify certificates and port settings. You can create up to 5 load balancers per AWS Region in your account.</p>"]
    fn create_load_balancer(
        &self,
        input: &CreateLoadBalancerRequest,
    ) -> Result<CreateLoadBalancerResult, CreateLoadBalancerError>;

    #[doc="<p>Creates a Lightsail load balancer TLS certificate.</p> <p>TLS is just an updated, more secure version of Secure Socket Layer (SSL).</p>"]
    ...
    #[doc="<p>Deletes the specified block storage disk. The disk must be in the <code>available</code> state (not attached to a Lightsail instance).</p> <note> <p>The disk may remain in the <code>deleting</code> state for several minutes.</p> </note>"]
    fn delete_disk(&self, input: &DeleteDiskRequest) -> Result<DeleteDiskResult, DeleteDiskError>;

    #[doc="<p>Deletes the specified disk snapshot.</p> <p>When you make periodic snapshots of a disk, the snapshots are incremental, and only the blocks on the device that have changed since your last snapshot are saved in the new snapshot. When you delete a snapshot, only the data not needed for any other snapshot is removed. So regardless of which prior snapshots have been deleted, all active snapshots will have access to all the information needed to restore the disk.</p>"]
    ...
    #[doc = "<p>Deletes a Lightsail load balancer.</p>"]
    fn delete_load_balancer(
        &self,
        input: &DeleteLoadBalancerRequest,
    ) -> Result<DeleteLoadBalancerResult, DeleteLoadBalancerError>;

    #[doc = "<p>Deletes a TLS/SSL certificate associated with a Lightsail load balancer.</p>"]
    ...
    #[doc="<p>Detaches a stopped block storage disk from a Lightsail instance. Make sure to unmount any file systems on the device within your operating system before stopping the instance and detaching the disk.</p>"]
    fn detach_disk(&self, input: &DetachDiskRequest) -> Result<DetachDiskResult, DetachDiskError>;

    #[doc = "<p>Detaches the specified instances from a Lightsail load balancer.</p>"]
    ...
    #[doc = "<p>Returns information about a specific block storage disk.</p>"]
    fn get_disk(&self, input: &GetDiskRequest) -> Result<GetDiskResult, GetDiskError>;

    #[doc = "<p>Returns information about a specific block storage disk snapshot.</p>"]
    fn get_disk_snapshot(
        &self,
        input: &GetDiskSnapshotRequest,
    ) -> Result<GetDiskSnapshotResult, GetDiskSnapshotError>;

    #[doc="<p>Returns information about all block storage disk snapshots in your AWS account and region.</p> <p>If you are describing a long list of disk snapshots, you can paginate the output to make the list more manageable. You can use the pageToken and nextPageToken values to retrieve the next items in the list.</p>"]
    fn get_disk_snapshots(
        &self,
        input: &GetDiskSnapshotsRequest,
    ) -> Result<GetDiskSnapshotsResult, GetDiskSnapshotsError>;

    #[doc="<p>Returns information about all block storage disks in your AWS account and region.</p> <p>If you are describing a long list of disks, you can paginate the output to make the list more manageable. You can use the pageToken and nextPageToken values to retrieve the next items in the list.</p>"]
    ...
    #[doc = "<p>Returns information about the specified Lightsail load balancer.</p>"]
    fn get_load_balancer(
        &self,
        input: &GetLoadBalancerRequest,
    ) -> Result<GetLoadBalancerResult, GetLoadBalancerError>;

    #[doc = "<p>Returns information about health metrics for your Lightsail load balancer.</p>"]
    ...
    #[doc="<p>Returns information about the TLS certificates that are associated with the specified Lightsail load balancer.</p> <p>TLS is just an updated, more secure version of Secure Socket Layer (SSL).</p>"]
    ...
    #[doc="<p>Returns information about all load balancers in an account.</p> <p>If you are describing a long list of load balancers, you can paginate the output to make the list more manageable. You can use the pageToken and nextPageToken values to retrieve the next items in the list.</p>"]
    ...
    #[doc = "<p>Updates the specified attribute for a load balancer.</p>"]
